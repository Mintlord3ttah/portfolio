            ...
            <section className="sec-bg flex justify-between gap-24 max-[1000px]:flex-col-reverse pt-40 ">
                <div className="flex-3/4 max-[1200px]:flex-1/2 ">
                    ...
                    <div className="">
                        ...
                        <p className="text-lg max-[1000px]:text-2xl mt-4">Hi, I'm a MERN-Stack/Mobile App developer with a passion for creating beautiful and functional user experiences.</p>
            ...
            <section className=" relative max-[1000px]:items-center" id="projects">
                <div ref={projectsRef} className="pt-36">
                    ...
                    <div className="grid grid-cols-4 max-[1100px]:grid-cols-2 max-[636px]:gap-4 max-[600px]:grid-cols-1 gap-8 w-fit">
                        ...
                        <ProjectCard img="fundaweb-best-landing-2.png" title="Fundaweb - Collaborative investment app" description="This is a collaborative investment app that allows users to pool resources and invest in real estate projects." link="https://fundaweb.com" />
                    </div>
                </div>
            </section>
