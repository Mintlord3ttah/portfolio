...
export default function About() {
  const {theme, specNavigation, setSpecNavigation} = useAppProvider()
  ...
  return <section className="sec-bg flex flex-col px-24 gap-8 pt-12 justify-between max-[1200px]:px-8 max-[500px]:px-4 max-[1000px]:flex-col max-[1000px]:items-center">
            ...
            <section className="flex flex-col w-full">
                <div ref={aboutMe} className="relative pt-28">
                    ...
                    <h2 className={`text-2xl  text-amber-700 z-10 backdrop-blur-xs px-8 py-4 w-fit rounded-full ${theme === "light" ? "bg-neutral-100/60" : "bg-neutral-800/60"}`}>About Me</h2>
                    <div className={`rounded-2xl ${theme === "light" ? "bg-neutral-100/60" : "bg-neutral-800/60"} p-8 max-[500px]:P-4 z-10 backdrop-blur-xs shadow mt-1`}>
                    <p className="text-xl max-[400px]:text-lg mt-8 ">Hi, I'm Confidence and my other name is Mint. I will like to introduce myself as a problem-solving and smart-working individual. I take on every little problem as a challenge and an opportunity to grow in my tech journey. </p>
                    <p className="text-xl max-[400px]:text-lg mt-8 ">Over the years I have honed my skills to a professional level and am proud to say this. Seeing my transformation into a whole new level backed by descipline, hardwork and grit, honestly its not always easy but its worth it. Perhaps, what makes me happy is seeing what I build solve real world problems and contributing to making life easy and the world a better place.</p>
                    </div>
                </div>
                ...
                <ul className=" z-10 backdrop-blur-2xl mt-8 flex flex-col gap-4">
                <Skill contain={true} name="Web Development">
                    ...
                    <Skill contain={true} name="Mobile App Development">
                    ...
                    <Skill contain={true} name="Maintenance and Support">
