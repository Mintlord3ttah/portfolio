...
export default function About() {
  ...
  return <section className="sec-bg flex flex-col px-24 gap-8 pt-12 justify-between max-[1200px]:px-8 max-[1000px]:flex-col max-[1000px]:items-center">
            ...
            <p className='text-2xl max-[490px]:text-xl text-center z-10 backdrop-blur-sm'>Your ideas may seem complex but <strong>code-split</strong> has a way out always. code split is a name I found appealing and suitable for solving real world problems with simplicity.</p>
